 ...
 * Last modified  : 2021-04-25 12:56:11
 */

const projectsContainers = document.querySelectorAll(".projet");
 ...
 * @param {event} e représente l'évènement clique 
 */
function showProject(e){
    getCurrentProject(e.target.dateset.projet);
    ...
    if(currentProject.type === "image"){
        ...
        <div class="half-item">
            ...
            <section class="like-section">
                <div class="img-like">
                    <img class="media-fluide" src="media/heart.png" alt="image de profil de l'utilisateur">
                </div>
