        ...
        $projects = $sth->fetchAll();
          ...
          <section class="content">
              <div class="youtube-responsive">
                  <!-- NE PAS OUBLIER LE EMBED DANS LE LIEN -->
                  <!-- NE PAS METTRE DE "&MUTE@" DANS LE LIEN SRC -->
                  <iframe width="1280" height="720" src="https://www.youtube.com/embed/QAA15b_CdRg"  frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
              </div>
